...
need|={'assets/quote/q3d.js','assets/vendor/three.min.js','assets/quote/logo-pdf.jpg','assets/quote/home-4x5.webp','assets/quote/home-plain-4x5.webp','assets/quote/home-16x10.webp','assets/quote/com-4x5.webp','assets/quote/com-16x10.webp'}
need|={'assets/quote/%s-%s.webp'%(a,b) for a,bs in [('style','0123456'),('hood','01234')] for b in bs}|{'assets/quote/prob-%s.webp'%k for k in ['win','hw','sol','pig','scr','large']}|{'assets/quote/tony-192.jpg','assets/vendor/gltf.min.js'}
