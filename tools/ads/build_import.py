...
GROUPS=[
 (HD,"Window Cleaning","window-cleaning.html","windows",
  ...
  ["Exterior window cleaning from $149 with screens, tracks and sills included. Firm price.",
   ...
   "Free quote, firm price in writing before we start. Openings this week in the High Desert."]),
...
assert not bad, bad
cols=["Account","Campaign","Campaign Type","Networks","Budget","Budget type","Bid Strategy Type","Maximum CPC bid limit","Campaign Status","Languages",
